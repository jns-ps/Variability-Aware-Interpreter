...
//  }
  ...
  @Test
  def testClasses() {
    val program: VariableProgram = parser.parseFile("programs\\test\\program_classes.txt")
    val store = program.run()
    store.print("Classes")
  }
  ...
  @Test
  def testClasses2() {
    val program: VariableProgram = parser.parseFile("programs\\test\\program_classes2.txt")
    val store = program.run()
  ...
  @Test
  def testClasses3() {
    val program: VariableProgram = parser.parseFile("programs\\test\\program_classes3.txt")
    val store = program.run()
  ...
  @Test
  def testCollections() {
    val program: VariableProgram = parser.parseFile("programs\\test\\program_collections.txt")
    val store = program.run()
...
////    FeatureExprFactory.setDefault(FeatureExprFactory.bdd)
//    
//    val program: VariableProgram = parser.parseFile("programs\\test\\program_GPL.txt")
//    val store = program.run()
